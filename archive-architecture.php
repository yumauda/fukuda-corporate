  ...
  <div class="p-category-anchor">
    ...
    <div class="p-category-anchor__block-wrapper">
      <div class="p-category-anchor__block">
        <a href="<?php echo esc_url(home_url('/engineer')); ?>" class="p-category-anchor__list-title no-now">土木事業ALL</a>
      ...
      <div class="p-category-anchor__block">
        <a href="<?php echo esc_url(home_url('/architecture')); ?>" class="p-category-anchor__list-title">建築事業ALL</a>
        <ul class="p-category-anchor__lists">
          <li class="p-category-anchor__list">
